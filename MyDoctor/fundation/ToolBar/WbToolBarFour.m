...
//    
//    blueLineVIew=[[UIView alloc]initWithFrame:CGRectMake(0, kTollBarHeight-4, appWidth/4, 4)];
...
//            blueLineVIew.frame = CGRectMake((selectedButton.tag-100)*appWidth/4, kTollBarHeight-4, appWidth/4, 4);
