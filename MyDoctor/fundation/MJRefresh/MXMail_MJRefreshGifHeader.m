...
@interface MXMail_MJRefreshGifHeader()
/** 所有状态对应的动画图片 */
...
@implementation MXMail_MJRefreshGifHeader
#pragma mark - 懒加载
        ...
        switch (state) {
            case MJRefreshHeaderStateIdle: {
                if (oldState == MJRefreshHeaderStateRefreshing) {
                    dispatch_after(dispatch_time(DISPATCH_TIME_NOW, (int64_t)(MXMail_MJRefreshSlowAnimationDuration * NSEC_PER_SEC)), dispatch_get_main_queue(), ^{
