...
@interface MXMail_MJRefreshLegendHeader()
@property (nonatomic, weak) UIImageView *arrowImage;
@property (nonatomic, weak) UIActivityIndicatorView *activityView;
@end

@implementation MXMail_MJRefreshLegendHeader
#pragma mark - 懒加载
    ...
    switch (state) {
        case MJRefreshHeaderStateIdle: {
            if (oldState == MJRefreshHeaderStateRefreshing) {
                ...
                [UIView animateWithDuration:MXMail_MJRefreshSlowAnimationDuration animations:^{
                ...
                [UIView animateWithDuration:MXMail_MJRefreshFastAnimationDuration animations:^{
                    self.arrowImage.transform = CGAffineTransformIdentity;
                }];
            }
            break;
