...
@class MXMail_MJRefreshGifHeader, MXMail_MJRefreshLegendHeader, MXMail_MJRefreshHeader;
@class MXMail_MJRefreshGifFooter, MXMail_MJRefreshLegendFooter, MXMail_MJRefreshFooter;

@interface UIScrollView (MXMail_MJRefresh)
#pragma mark - 访问下拉刷新控件
/** 下拉刷新控件 */
@property (strong, nonatomic, readonly) MXMail_MJRefreshHeader *header;
/** gif功能的下拉刷新控件 */
@property (nonatomic, readonly) MXMail_MJRefreshGifHeader *gifHeader;
/** 传统的下拉刷新控件 */
@property (nonatomic, readonly) MXMail_MJRefreshLegendHeader *legendHeader;
...
/** 上拉刷新控件 */
@property (strong, nonatomic, readonly) MXMail_MJRefreshFooter *footer;
/** gif功能的上拉刷新控件 */
@property (nonatomic, readonly) MXMail_MJRefreshGifFooter *gifFooter;
/** 传统的上拉刷新控件 */
@property (nonatomic, readonly) MXMail_MJRefreshLegendFooter *legendFooter;
