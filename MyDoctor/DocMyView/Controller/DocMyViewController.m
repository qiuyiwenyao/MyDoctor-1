...
@interface DocMyViewController ()<UITableViewDataSource,UITableViewDelegate>
{
...
@implementation DocMyViewController
...
-(NSMutableArray *)dataList
{
    if (_dataList == nil) {
        ...
        MDMyViewItem * group0 = [MDMyViewItem itemsWithIcon:@"mydoctor" andTitle:@"我的患者" andRightImage:@"arrow"];
        
        MDMyViewItem * group1 = [MDMyViewItem itemsWithIcon:@"feedback" andTitle:@"意见反馈" andRightImage:@"arrow"];
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    {
        DocMyPatientsViewController * myPatientsVC = [[DocMyPatientsViewController alloc] init];
        myPatientsVC.hidesBottomBarWhenPushed = YES;
        [self.navigationController pushViewController:myPatientsVC animated:YES];
    }
